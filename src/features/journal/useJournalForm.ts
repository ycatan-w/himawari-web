...
import { nextTick, onMounted, ref, toValue, watch, type ModelRef, type Ref } from "vue";

export function useJournalForm(newEntry: ModelRef<string>, entryToEdit: ModelRef<{id: number|null, text: string}>, entries: Ref<JournalData[]>, date: Date) {
  ...
  return { textareaElemRef, textareaRef, maxHeight: `${maxHeight}px`, autoResize, onEnter, onEscape };
}
