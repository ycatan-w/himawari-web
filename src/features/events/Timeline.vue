...
const { computedPositionedEvents, computedGhostPosition, selectEventAction, handleTimelineClickAction } = useTimeline(selectedEventId, toRef(props, 'rawEventsRef'), ghostStart);
    ...
    <div class="flex flex-col h-full">
      ...
      <div
        :class="[
          ...
          featureColorTheme.timeline_events
        ]"
